...
parser.add_argument("--data", type=str, default=None, help="Dataset labels")
parser.add_argument("--images", type=str, default=None, help="Dataset folder")
parser.add_argument("--results", type=str, default=None, help="CSV file of the results")
